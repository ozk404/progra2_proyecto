                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-12 text-center pb-5">
                            ...
                            <h5>Aquí puede gestionar (crear, editar, eliminar) todo lo relacionado con Usuarios del sistema, un Hotel del sistema</h5>
                        </div>
                        <div class="row">
                            <div class="container text-center">

                                <!-- Formulario para ver la lista de usuarios -->
                                <form action="listado-hoteles.php" method="post">
                                    <button class="col-8 btn btn-primary" name="accion" value="usuarios">Ver Listado</button>
                                </form>
                                <br class="pb-15 pt-5">

                                <!-- Formulario para crear un Hotel -->
                                <form action="crear-hotel.php" method="post">
                                    <button class="col-8 btn btn-secondary" name="accion" value="hotel">Crear Hotel</button>
                                </form>
                                <br class="pb-5 pt-5">

                                <!-- Formulario para editar un Hotel -->
                                <form action="listado-hoteles.php" method="post">
                                    <button class="col-8 btn btn-warning" name="accion" value="editar_usuario">Editar Hotel</button>
                                </form>
                                <br class="pb-5 pt-5">

                                <!-- Formulario para borrar un Hotel -->
                                <form action="listado-hoteles.php" method="post">
                                    <button class="col-8 btn btn-danger" name="accion" value="borrar_usuario">Borrar Hotel</button>
                                </form>
