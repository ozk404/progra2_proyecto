...
<body class="animsition">
                    ...
                    <div class="container-fluid">
                      ...
                      <a href="crear-tipohabitacion.php">⬅️ Haz click aquí para crear un nuevo Tipo de habitación </a>     
                       <br>
                        ...
                        <?php
                                $usuariosJson = file_get_contents('http://172.19.0.5/backend/tipo_habitacion');
                            ...
                            <div class="container mt-5">
                                ...
                                <script>
                                    ...
                                    function eliminarUsuario(usuarioId) {
                                        ...
                                        fetch(`http://127.0.0.1/backend/tipo_habitacion/${usuarioId}`, {
                                                method: 'DELETE'
                                            })
                                            .then(response => {
                                                if (response.ok) {
    ...
    `;
                                    ...
                                    function actualizarUsuario(data) {
                                        fetch(`http://127.0.0.1/backend/tipo_habitacion/${data.id}`, {
