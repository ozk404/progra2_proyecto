...
<body class="animsition">
                    ...
                    <div class="container-fluid">
                      ...
                      <a href="crear.php">⬅️ Haz click aquí para crear un nuevo Usuario </a>     
                       <br>
                        ...
                        <?php
                                $usuariosJson = file_get_contents('http://104.197.54.121/backend/usuarios');
                            ...
                            <div class="container mt-5">
                                ...
                                <script>
                                    ...
                                    function eliminarUsuario(usuarioId) {
                                        ...
                                        fetch(`http://104.197.54.121/backend/usuarios/${usuarioId}`, {
                                                method: 'DELETE'
                                            })
                                            .then(response => {
                                                if (response.ok) {
    ...
    `;
                                    ...
                                    function actualizarUsuario(data) {
                                        fetch(`http://104.197.54.121/backend/usuarios/${data.id}`, {
