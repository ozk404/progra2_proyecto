                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-12 text-center pb-5">
                            <h1>Bienvenido a la sección de Crear un nuevo Usuario</h1>
                            <h5>Aquí puede crear, a un Usuario del sistema, un Usuario es la persona que puede acceder al sistema</h5>
                            <br>
                      <a href="listado.php">⬅️ Haz click aquí para ver el listado de Usuarios </a>     
                       <br>
                        </div>
                        <div class="row">
                            <div class="col"></div>
                            ...
                            <script>
                                document.getElementById('usuarioForm').addEventListener('submit', function(event) {
                                    ...
                                    fetch('http://104.197.54.121/backend/usuarios', {
                                            method: 'POST',
                                            headers: {
