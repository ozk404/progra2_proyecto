                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-12 text-center pb-5">
                            <h1>Bienvenido a la sección de Crear un nuevo Hotel</h1>
                            <h5>Aquí puede crear, a un Hotel del sistema</h5>
                            <br>
                      <a href="listado-hoteles.php">⬅️ Ver el listado de Hoteles </a>     
                       <br>
                        </div>
                        <div class="row">
                            <div class="col"></div>
                                    ...
                                    <div class="card-body">
                                        <form id="usuarioForm" class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" required class="form-control" id="nombre" placeholder="Hotel Maravilla">
                                            </div>
                                            <div class="col-12">
                                                <label for="identificacion" class="form-label">Dirección</label>
                                                <input type="text" required class="form-control" id="direccion" placeholder="Zona 12, Guatemala">
                                            </div>
                                            <div class="col-12">
                                ...
                                document.getElementById('usuarioForm').addEventListener('submit', function(event) {
                                    ...
                                    fetch('http://104.197.54.121/backend/hoteles', {
                                        ...
                                        .then(data => {
                                            ...
                                            Swal.fire({
                                                title: 'Éxito!',
                                                text: data.message || 'Hotel creado correctamente.',
                                                icon: 'success',
