...
<body class="animsition">
                    ...
                    <div class="container-fluid">
                      ...
                      <a href="listado-hoteles.php">Ver el listado de Hoteles </a>     
                       <br>
                        ...
                        <?php
                                $usuariosJson = file_get_contents('http://172.19.0.5/backend/hoteles');
                            ...
                            <div class="container mt-5">
                                ...
                                <script>
                                    ...
                                    function eliminarUsuario(usuarioId) {
                                        ...
                                        fetch(`http://127.0.0.1/backend/hoteles/${usuarioId}`, {
                                                method: 'DELETE'
                                            })
                                            .then(response => {
                                                if (response.ok) {
    ...
    `;
                                    ...
                                    function actualizarUsuario(data) {
                                        fetch(`http://127.0.0.1/backend/hoteles/${data.id}`, {
