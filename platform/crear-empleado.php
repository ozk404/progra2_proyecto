                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-12 text-center pb-5">
                            <h1>Bienvenido a la sección de Crear un nuevo Empleado</h1>
                            <h5>Aquí puede crear, a un Empleado del sistema</h5>
                            <br>
                            <a href="listado-empleados.php">⬅️ Ver el listado de Empleados </a>
                            <br>
                        </div>
                        <div class="row">
                            <div class="col"></div>
                                    ...
                                    <div class="card-body">
                                        <form id="usuarioForm" class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <input type="text" required class="form-control" id="nombre" placeholder="Oscar Morales Cuellar">
                                            </div>
                                            <div class="col-12">
                                                <label for="identificacion" class="form-label">Identificación</label>
                                                <input type="text" required class="form-control" id="identificacion" placeholder="12345">
                                            </div>
                                            <div class="col-12">
                                                <label for="correo" class="form-label">Correo</label>
                                                <input type="email" required class="form-control" id="correo" placeholder="omoralesc12@miumg.edu.gt">
                                            </div>
                                            <div class="col-12">
                                                <label for="telefono" class="form-label">Teléfono</label>
                                                <input type="number" required class="form-control" id="telefono" placeholder="12345">
                                            </div>
                                            <div class="col-12">
                                                <label for="puesto" class="form-label">Puesto</label>
                                                <input type="text" required class="form-control" id="puesto" placeholder="Gerente">
                                            </div>
                                            <div class="col-12">
                                    ...
                                    fetch('https://localhost/backend/empleados', {
                                        ...
                                        .then(response => {
                                            if (response.ok) {
                                                ...
                                                Swal.Fire("Error", "No se pudo crear el empleado. Intenta nuevamente.", "error");
                                            }
                                        })
                                        .catch(error => {
                                            console.error('Error:', error);
