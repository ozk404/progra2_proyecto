                        ...
                        <div class="row">
                            <div class="container text-center">
                                ...
                                <form action="crear.php" method="post">
                                    <button class="col-8 btn btn-secondary" name="accion" value="crear_usuario">Crear Usuario</button>
                                </form>
                                <br class="pb-5 pt-5">

                                <!-- Formulario para editar un usuario -->
                                <form action="listado.php" method="post">
                                    <button class="col-8 btn btn-warning" name="accion" value="editar_usuario">Editar Usuario</button>
                                </form>
                                <br class="pb-5 pt-5">

                                <!-- Formulario para borrar un usuario -->
                                <form action="listado.php" method="post">
                                    <button class="col-8 btn btn-danger" name="accion" value="borrar_usuario">Borrar Usuario</button>
                                </form>
