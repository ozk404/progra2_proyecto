                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-12 text-center pb-5">
                            <h1>Bienvenido a la sección de Crear un nuevo Cliente</h1>
                            <h5>Aquí puede crear, a un Cliente del sistema</h5>
                            <br>
                            <a href="listado-clientes.php">⬅️ Ver el listado de Clientes </a>
                            <br>
                        </div>
                        <div class="row">
                            <div class="col"></div>
